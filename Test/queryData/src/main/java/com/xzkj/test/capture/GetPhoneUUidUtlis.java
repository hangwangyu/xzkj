...
public class GetPhoneUUidUtlis {
    ...
    private static GetPhoneUUidUtlis deviceUuidFactory;
    public static GetPhoneUUidUtlis getInstance(Context context){
        if (deviceUuidFactory == null){
            deviceUuidFactory = new GetPhoneUUidUtlis(context);
        }
        return deviceUuidFactory;
    }

    @SuppressLint("MissingPermission")
    private GetPhoneUUidUtlis(Context context) {

        if (uuid == null) {
            synchronized (GetPhoneUUidUtlis.class) {
                if (uuid == null) {
